            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            ...
                            <div className="aspect-square bg-gradient-to-br from-blue-400 to-cyan-500 mb-4 flex items-center justify-center overflow-hidden border-4 border-gray-700">
                                <img src={avatarImg} alt="GameTag" className="w-full h-full object-cover" />
                            </div>
                            <div className="bg-gray-900 text-white p-4 border-2 border-gray-700 mb-3">
                                <p className="font-terminal text-xs text-gray-400 mb-1">[ Your GameTag ]</p>
                        ...
                        >
                            {[1, 2, 3].map((day) => (
                                <button
                                    ...
                                    className={`font-pixel px-8 py-4 text-sm border-4 transition-all relative ${activeDay === day
                            ...
                            {scheduleData[activeDay].map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p className="font-pixel text-base text-white mb-1">{item.event}</p>
                                        <p className="font-terminal text-xs text-gray-400">Event ID: EVT-{activeDay}{index + 1}</p>
                                    </div>
                ...
                <div className="mt-16 border-t-2 border-gray-700 pt-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-8">
                        <div>
                            <h3 className="font-pixel text-sm text-gray-300 mb-3 tracking-wider">COORDINATORS</h3>
                            <div className="space-y-1">
                                <p className="font-terminal text-xs text-gray-400">Pranav garg</p>
                                <p className="font-terminal text-xs text-gray-500">+91 XXXXXXXXXX</p>
                                <p className="font-terminal text-xs text-gray-500">xxxxxxxxxx</p>
                            </div>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <div className="text-5xl mb-3">🎮</div>
                            <h2 className="font-minecraft text-4xl text-white mb-2">MERAKI</h2>
                            <p className="font-terminal text-xs text-gray-400">Indian Institute Of</p>
                            <p className="font-terminal text-xs text-gray-400">Information Technology Una</p>
                        </div>
                        <div>
                            <h3 className="font-pixel text-sm text-gray-300 mb-3 tracking-wider">CONNECT WITH US</h3>
                            <div className="space-y-1">
                                <p className="font-terminal text-xs text-gray-400">Instagram</p>
                                <p className="font-terminal text-xs text-gray-400">LinkedIn</p>
