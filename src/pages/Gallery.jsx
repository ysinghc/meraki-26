            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                        ...
                        {galleryCollections.map((collection, index) => (
                            <div
                                ...
                                className={`border-4 border-black bg-gray-100 cursor-pointer hover:bg-gray-200 transition-all flex flex-col items-center justify-center p-6
                                    ${index === 0 ? 'md:row-span-2 min-h-[400px]' : ''}
                                    ${index === 3 ? 'md:col-span-2 min-h-[190px]' : 'min-h-[190px]'}
                                    ${index === 5 ? 'md:col-span-2' : ''}
                                `}
                            >
                                <div className="text-6xl mb-4">📁</div>
                                <h3 className="font-pixel text-lg text-black mb-2">{collection.title}</h3>
                                <p className="font-terminal text-sm text-gray-600">{collection.count} images</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    ...
                    <div>
                        ...
                        <p className="font-terminal text-xs text-gray-400 mb-2">XXXXXXXXXX</p>
                        <p className="font-terminal text-xs text-gray-400">Pranav garg</p>
                        <p className="font-terminal text-xs text-gray-400">+91 XXXXXXXXXX</p>
