...
const About = () => {
    return (
        <section className="relative min-h-screen w-full overflow-x-hidden bg-black">
            {/* Background Image */}
            <div
                className="fixed inset-0 z-0 w-full h-full bg-center"
                style={{ 
            ...
            {/* Content Container */}
            <div className="relative z-10 min-h-screen pt-28 md:pt-20 pb-4 px-4 md:px-8 lg:px-12 flex items-center">
