        ...
        >
            ...
            <div className="hidden lg:flex items-center gap-6">
                <div className="flex gap-6 font-pixel text-white/80 text-sm tracking-widest">
                    ...
                    <button onClick={() => handleNavigation('sponsors')} className="hover:text-white cursor-pointer hover:underline decoration-accent-400 underline-offset-4 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(6,182,212,0.6)]">SPONSORS</button>
                    <Link to="/contact" className="hover:text-white cursor-pointer hover:underline decoration-accent-400 underline-offset-4 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(6,182,212,0.6)]">CONTACT US</Link>
                </div>
                    ...
                    >
                        <div className="flex flex-col gap-8 font-pixel text-white text-xl tracking-widest text-center">
                            ...
                            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25 }}>
                                <Link to="/gallery" onClick={toggleMenu} className="hover:text-accent-400 cursor-pointer transition-all duration-300 hover:scale-110 inline-block">GALLERY</Link>
                            </motion.div>
                            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
                                <Link to="/team" onClick={toggleMenu} className="hover:text-accent-400 cursor-pointer transition-all duration-300 hover:scale-110 inline-block">TEAM</Link>
                            </motion.div>
                            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.35 }}>
                                <button onClick={() => handleNavigation('sponsors')} className="hover:text-accent-400 cursor-pointer transition-all duration-300 hover:scale-110 inline-block">SPONSORS</button>
                            </motion.div>
                            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
                                <Link to="/contact" onClick={toggleMenu} className="hover:text-accent-400 cursor-pointer transition-all duration-300 hover:scale-110 inline-block">CONTACT US</Link>
                            </motion.div>
                            <Link
